...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.MainViewHolder> {
    ...
    public RecipeAdapter(ArrayList<Recipes> listRecipes, OnItemClickListener listener) {
